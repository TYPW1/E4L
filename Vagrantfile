...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "forwarded_port", guest: 8088, host: 8085
  ...
  # Run the post provision verification script
  config.vm.provision "shell", path: "scripts/post_provision_verify.sh"
  end
