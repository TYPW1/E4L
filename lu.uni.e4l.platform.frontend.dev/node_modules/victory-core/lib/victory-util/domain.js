...
exports.default = {
  ...
  getDomainFromData: function (props, axis, dataset) {
    ...
    var allData = flatData.map(function (datum) {
      return datum["_" + currentAxis + "1"] === undefined ? datum["_" + currentAxis] : datum["_" + currentAxis + "1"];
    });
    var allMinData = flatData.map(function (datum) {
      return datum["_" + currentAxis + "0"] === undefined ? datum["_" + currentAxis] : datum["_" + currentAxis + "0"];
    });
    if (allData.length < 1) {
    ...
    return polar && axis === "x" && Math.abs(startAngle - endAngle) === 360 ? this.getSymmetricDomain(domain, allData) : domain;
  },
  ...
  getDomainFromTickValues: function (props, axis) {
    ...
    if (_helpers2.default.stringTicks(props)) {
      ...
      domain = polar && axis === "x" && Math.abs(startAngle - endAngle) === 360 ? this.getSymmetricDomain(initialDomain, ticks) : initialDomain;
    }
  ...
  getDomainFromCategories: function (props, axis) {
    var polar = props.polar,
        _props$startAngle3 = props.startAngle,
        startAngle = _props$startAngle3 === undefined ? 0 : _props$startAngle3,
        _props$endAngle3 = props.endAngle,
        endAngle = _props$endAngle3 === undefined ? 360 : _props$endAngle3;
    ...
    var categoryDomain = [_collection2.default.getMinValue(categoryValues), _collection2.default.getMaxValue(categoryValues)];
    return polar && axis === "x" && Math.abs(startAngle - endAngle) === 360 ? this.getSymmetricDomain(categoryDomain, categoryValues) : categoryDomain;
  },
