...
exports.default = {
  ...
  getDomainFromChildren: function (props, axis, childComponents) {
    ...
    var parentProps = parentData ? { data: parentData, polar: polar, startAngle: startAngle, endAngle: endAngle, categories: categories } : { polar: polar, startAngle: startAngle, endAngle: endAngle, categories: categories };
