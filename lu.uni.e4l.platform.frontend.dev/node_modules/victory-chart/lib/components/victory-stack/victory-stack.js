...
var VictoryStack = function (_React$Component) {
  ...
  _createClass(VictoryStack, [{
    ...
    value: function getCalculatedProps(props, childComponents) {
      ...
      var domain = {
        x: _wrapper2.default.getStackedDomain((0, _assign3.default)({}, props, { categories: categories }), "x", datasets),
        y: _wrapper2.default.getStackedDomain((0, _assign3.default)({}, props, { categories: categories }), "y", datasets)
      };
      var range = {
