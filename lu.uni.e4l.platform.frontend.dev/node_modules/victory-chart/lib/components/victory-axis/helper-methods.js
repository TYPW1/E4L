...
exports.getStyles = exports.getScale = exports.getAxis = exports.getDomain = exports.getBaseProps = undefined;
...
var getScale = function (props) {
  ...
  var domain = getDomain(props) || scale.domain();
...
var getStyleObject = function (props) {
  ...
  var mergeStyles = function () {
    ...
    return styleNamespaces.reduce(function (memo, curr) {
      memo[curr] = (0, _defaults3.default)({}, specificAxisStyle[curr], generalAxisStyle[curr]);
      return memo;
    }, {});
  };
...
var getBaseProps = function (props, fallbackProps) {
  ...
  return ticks.reduce(function (childProps, tick, index) {
    ...
    childProps[index] = {
      ...
      ticks: (0, _assign3.default)({}, sharedProps, getTickProps(tickLayout, styles.tickStyle, tick)),
      tickLabels: (0, _assign3.default)({}, sharedProps, getTickLabelProps(tickLayout, styles.labelStyle, anchors, tick, tickFormat(tick, index, ticks))),
      grid: (0, _assign3.default)({}, sharedProps, gridProps, getGridProps(gridLayout, styles.gridStyle, tick))
    };
    return childProps;
  }, initialChildProps);
};
