...
var VictoryChart = function (_React$Component) {
  ...
  _createClass(VictoryChart, [{
    ...
    value: function getCalculatedProps(props, childComponents) {
      ...
      var domain = {
        x: (0, _helperMethods.getDomain)((0, _assign3.default)({}, props, { categories: categories }), "x", childComponents),
        y: (0, _helperMethods.getDomain)((0, _assign3.default)({}, props, { categories: categories }), "y", childComponents)
      };
      var range = {
