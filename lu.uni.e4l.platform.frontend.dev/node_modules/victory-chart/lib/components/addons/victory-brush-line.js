...
var VictoryBrushLine = function (_React$Component) {
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderHandles(props) {
      ...
      var minDatum = (0, _assign3.default)({ handleValue: _victoryCore.Collection.getMinValue(brushDomain) }, datum);
      var maxDatum = (0, _assign3.default)({ handleValue: _victoryCore.Collection.getMaxValue(brushDomain) }, datum);
    ...
    eventHandlers: {
      onMouseEnter: function (evt, targetProps) {
        ...
        var activeBrushes = {
          ...
          brush: withinBound(position, range) && !(0, _reactFastCompare2.default)(fullDomain, currentDomain),
      ...
      onMouseDown: function (evt, targetProps) {
        ...
        } else if (withinBound(position, range) && !(0, _reactFastCompare2.default)(fullDomain, currentDomain)) {
      ...
      onMouseMove: function (evt, targetProps) {
        ...
        var activeBrushes = {
          brushArea: !targetProps.brushDomain,
          brush: withinBound(position, initialRange) && !(0, _reactFastCompare2.default)(fullDomain, domain),
          minHandle: activeHandle === "min" || activeHandle === "both",
