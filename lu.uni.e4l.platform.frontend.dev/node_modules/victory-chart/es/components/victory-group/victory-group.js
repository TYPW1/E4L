...
import { Helpers, VictorySharedEvents, VictoryContainer, VictoryTheme, Scale, Data } from "victory-core";
...
var VictoryGroup = function (_React$Component) {
  ...
  _createClass(VictoryGroup, [{
    ...
    value: function getCalculatedProps(props, childComponents) {
      ...
      var domain = {
        x: Wrapper.getDomain(_assign({}, modifiedProps, { categories: categories }), "x", childComponents),
        y: Wrapper.getDomain(_assign({}, modifiedProps, { categories: categories }), "y", childComponents)
      };
      var range = {
...
VictoryGroup.propTypes = _extends({}, BaseProps, DataProps, {
...
VictoryGroup.getDomain = Wrapper.getDomain.bind(Wrapper);
VictoryGroup.getData = Wrapper.getData.bind(Wrapper);
