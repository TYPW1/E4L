...
.was-validated .form-control:valid, .form-control.is-valid {
  ...
  background-image: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%235eba00' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-check'><polyline points='20 6 9 17 4 12'></polyline></svg>");
  background-repeat: no-repeat;
  background-position: center right calc(0.34375em + 0.1875rem);
...
.was-validated .custom-select:valid, .custom-select.is-valid {
  ...
  background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") no-repeat right 0.75rem center/8px 10px, url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%235eba00' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-check'><polyline points='20 6 9 17 4 12'></polyline></svg>") #fff no-repeat center right 1.75rem/calc(0.6875em + 0.375rem) calc(0.6875em + 0.375rem); }
...
.was-validated .form-control:invalid, .form-control.is-invalid {
  border-color: #fa4654;
  padding-right: calc(1.375em + 0.75rem);
  background-image: url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%23fa4654' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-x'><line x1='18' y1='6' x2='6' y2='18'></line><line x1='6' y1='6' x2='18' y2='18'></line></svg>");
  background-repeat: no-repeat;
  background-position: center right calc(0.34375em + 0.1875rem);
  background-size: calc(0.6875em + 0.375rem) calc(0.6875em + 0.375rem); }
...
.was-validated .custom-select:invalid, .custom-select.is-invalid {
  border-color: #fa4654;
  padding-right: calc((1em + 0.75rem) * 3 / 4 + 1.75rem);
  background: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 4 5'%3e%3cpath fill='%23343a40' d='M2 0L0 2h4zm0 5L0 3h4z'/%3e%3c/svg%3e") no-repeat right 0.75rem center/8px 10px, url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%23fa4654' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-x'><line x1='18' y1='6' x2='6' y2='18'></line><line x1='6' y1='6' x2='18' y2='18'></line></svg>") #fff no-repeat center right 1.75rem/calc(0.6875em + 0.375rem) calc(0.6875em + 0.375rem); }
...
.custom-checkbox .custom-control-input:disabled:checked ~ .custom-control-label::before {
  background-color: rgba(32, 107, 196, 0.5); }
...
.custom-range {
  ...
  .custom-range:focus {
    ...
    .custom-range:focus::-webkit-slider-thumb {
      box-shadow: 0 0 0 1px #f8fafb, 0 0 0 0.2rem rgba(32, 107, 196, 0.25); }
...
button.bg-primary:focus {
  background-color: #195398 !important; }
...
button.bg-danger:focus {
  background-color: #f91426 !important; }
...
@media print {
  ...
  *::after {
  ...
  .table, .markdown table {
    ...
    .table td,
    .markdown table td, .table th, .markdown table th {
      background-color: #fff !important; }
  .table-bordered th, .markdown table th,
  .table-bordered td,
  .markdown table td {
...
@font-face {
  ...
  src: url("fonts/tabler-webfont/tabler-webfont.eot?5b97781fda75d54b60ae8ffe0c129c97?#iefix") format("embedded-opentype"), url("fonts/tabler-webfont/tabler-webfont.woff2?5b97781fda75d54b60ae8ffe0c129c97") format("woff2"), url("fonts/tabler-webfont/tabler-webfont.woff?5b97781fda75d54b60ae8ffe0c129c97") format("woff"), url("fonts/tabler-webfont/tabler-webfont.ttf?5b97781fda75d54b60ae8ffe0c129c97") format("truetype"), url("fonts/tabler-webfont/tabler-webfont.svg?5b97781fda75d54b60ae8ffe0c129c97#tabler-webfont") format("svg");
  font-weight: normal;
  font-style: normal; }
...
.navbar-side {
  ...
  .navbar-side .nav-link {
    ...
    .navbar-side .nav-link.active, .navbar-side .nav-link:hover {
      color: #1C2C41;
    ...
    .navbar-side .nav-link > .icon {
      width: 2rem; }
    .navbar-side .nav-link[data-toggle="collapse"].active {
      background: none;
      box-shadow: none; }
  ...
  .navbar-side:not(.sidenav-folded) .nav-item .nav-item .nav-link {
    padding-left: 2.5rem; }
  .navbar-side:not(.sidenav-folded) .nav-item .nav-item .nav-item .nav-link {
    padding-left: 3.5rem; }
  .navbar-side:not(.sidenav-folded) .nav-item .nav-item .nav-item .nav-item .nav-link {
    padding-left: 4.5rem; }
  .navbar-side .nav-link-title {
    display: flex;
    width: 100%;
    align-items: center; }
...
.navbar-dark {
  ...
  .navbar-dark .nav-link {
    color: #adb5bd; }
    .navbar-dark .nav-link.active, .navbar-dark .nav-link:hover {
      color: #fff;
...
Utils
 */
.sidenav.sidenav-folded .hide-sidenav-folded {
  display: none; }

.sidenav:not(.sidenav-folded) .hide-sidenav-expanded {
  display: none; }
...
.imagecheck-figure {
  ...
  .imagecheck-figure::before {
    ...
    -ms-user-select: none;
    user-select: none;
    background: #206bc4 url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%23fff' d='M6.564.75l-3.59 3.612-1.538-1.55L0 4.26 2.974 7.25 8 2.193z'/%3e%3c/svg%3e") no-repeat center center/50% 50%;
    border-radius: 3px;
    opacity: 0;
    transition: .3s opacity; }
...
.chart-placeholder {
  background-image: linear-gradient(135deg, rgba(0, 0, 0, 0.09) 25%, transparent 25%, transparent 50%, rgba(0, 0, 0, 0.09) 50%, rgba(0, 0, 0, 0.09) 75%, transparent 75%, transparent 100%);
...
.text-subheader, .navbar-side .navbar-heading {
  font-size: 0.75rem;
  font-weight: 600;
  color: #888e9a;
  text-transform: uppercase;
